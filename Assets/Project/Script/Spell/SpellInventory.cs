...
public class SpellInventory
{
    ...
    public void PlayerBasicSpellInit()
    {
        ...
        spellList.Add(CreateSpell("Invisibility", 0, 50, "Cast the power of the dark night to become Invisible ... But you're weapon are still visible ..."));

        for (int i = 0; i < 31.4; i++)
            spellList.Add(CreateSpell("pi", 3.14f, 1, "MATH"));
    }
